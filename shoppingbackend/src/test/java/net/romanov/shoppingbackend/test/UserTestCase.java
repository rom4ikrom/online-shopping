...
//		
//		address = new Address();
//		address.setAddressLineOne("301/B Jadoo Society");
//		address.setAddressLineTwo("Near Kudrat Store");
...
//	}
	...
	public void testGetAddresses() {
		...
		assertEquals("Failder to fetch the list of addresses and size does not match", 2,
				userDAO.listShippingAddresses(user).size());
		
		assertEquals("Failder to fetch the list of billing address and size does not match", "Mumbai",
